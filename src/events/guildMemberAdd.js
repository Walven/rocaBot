...
module.exports = {
	...
	execute: (client, member) => {
		...
		+ 'Here you\'ll find the resources to download and learn how to use Pokémon Studio & Pokémon SDK, in order to create your very own Pokémon fangame. '
		...
		+ 'Ici, tu trouveras de quoi Télécharger et apprendre à utiliser Pokémon Studio & Pokémon SDK, pour créer ton propre fangame Pokémon. '
